...
map("n", "<leader>ud", function() Snacks.dashboard() end, { desc = "Open Snacks dashboard" })

map({ "n", "v", "x" }, "<leader>e", function() Snacks.explorer() end, { desc = "Toggle file explorer" })

-- Snacks.picker
map({ "n" }, "<leader><space>", function() Snacks.picker.files() end, { desc = "File picker" })

map({ "n" }, "<leader>gd", function() Snacks.picker.git_diff() end, { desc = "Git diff" })
map({ "n" }, "<leader>gs", function() Snacks.picker.git_status() end, { desc = "Git status" })
map({ "n" }, "<leader>gla", function() Snacks.picker.git_log() end, { desc = "Git log (repo)" })
map({ "n" }, "<leader>glf", function() Snacks.picker.git_log_file() end, { desc = "Git log (file)" })
map({ "n" }, "<leader>gll", function() Snacks.picker.git_log_line() end, { desc = "Git log (line)" })
if vim.fn.executable("lazygit") == 1 then map("n", "<leader>gg", function() Snacks.lazygit() end, { desc = "Lazygit" }) end
...
map({ "n" }, "<leader>sb", function() Snacks.picker.grep_buffers() end, { desc = "Grep buffer" })
map({ "n" }, "<leader>sB", function() Snacks.picker.buffers() end, { desc = "Buffers" })
map({ "n" }, "<leader>sl", function() Snacks.picker.lines() end, { desc = "Lines" })
